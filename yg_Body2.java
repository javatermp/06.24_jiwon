...
public class Body2 extends JPanel{
	...
	public Body2(PictureChange temp) {
		try {
			myClient = new Socket("127.0.0.1", 8199);
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		img = new ImageIcon("C:/Users/MELEE/eclipse-workspace/Term/src/Term/Background2.gif");
		log = new JTextArea();
		...
		ImageIcon normalIcon = new ImageIcon("C:/Users/MELEE/eclipse-workspace/Term/src/Term/gameover.gif");	
		...
		ImageIcon normalIcon1 = new ImageIcon("C:/Users/MELEE/eclipse-workspace/Term/src/Term/num1.png");
		map1 = new JButton("맵1");
		map1.setSize(80, 60);
		...
		ImageIcon normalIcon2 = new ImageIcon("C:/Users/MELEE/eclipse-workspace/Term/src/Term/num2.png");
		map2 = new JButton("맵2");
		map2.setSize(80, 60);
		...
		ImageIcon normalIcon3 = new ImageIcon("C:/Users/MELEE/eclipse-workspace/Term/src/Term/num3.png");
		map3 = new JButton("맵3");
		map3.setSize(80, 60);
		...
		ImageIcon normalIcon4 = new ImageIcon("C:/Users/MELEE/eclipse-workspace/Term/src/Term/num4.png");
		map4 = new JButton("맵4");
		map4.setSize(80, 60);
	...
	private class ChangeListener implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			...
			count++;
			try {
				System.out.println(br.readLine() + " >> Body2");
			} catch (IOException e) {
